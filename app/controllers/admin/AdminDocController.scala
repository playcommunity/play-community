      ...
      tuple => {
        ...
        _idOpt match {
          ...
          case None =>
            ...
            mongo.insertOne[Doc](Doc(_id, title, "", content, "", RequestHelper.getAuthor, Nil, None, ViewStat(0, ""), VoteStat(0, ""), ReplyStat(0, 0, ""),  CollectStat(0, ""), DateTimeUtil.now, DateTimeUtil.now, false, false, false, Resource.Doc, catalogId)).map{ wr =>
