      ...
      tuple => {
        ...
        _idOpt match {
          ...
          case None =>
            ...
            mongo.insertOne[Doc](Doc(_id, title, content, "", RequestHelper.getAuthor, List.empty[Reply], ViewStat(0, ""), VoteStat(0, ""), ReplyStat(0, 0, ""),  CollectStat(0, ""), DocTimeStat(DateTimeUtil.now, DateTimeUtil.now), catalogId)).map{ wr =>
